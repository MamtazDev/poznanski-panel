...
const RadioTv: React.FC<TableProps> = ({
  ...
  const handleArtistChange = (artists: string[]) => {
    setEditData((prev: any) => ({ ...prev, artists }));
  };
            ...
            {radioData.length > 0 ? (
              radioData?.map((item, idx) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    ...
                    >
                      <img
                        src={
                          item?.youTube
                            ? `https://img.youtube.com/vi/${getYouTubeID(item?.youTube)}/hqdefault.jpg`
                  ...
                  <td className="px-4 py-3">
                    {" "}
                    {item?.tags && item?.tags.split(",").length > 0 ? (
                      <>
                        {item?.tags.split(",").slice(0, 3).join(", ")}
                        <span style={{}}>
                          {" "}
                          {item?.tags.split(",").length > 3 && " and more..."}
                        </span>
                      </>
                    ) : (
                      "No tags available"
              ...
              <FormControl isRequired>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    const currentValues = editData?.artists || [];
                ...
                {(editData?.artists || []).length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-2">
                    {(editData?.artists || []).map((artistId: string) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            onClick={() => {
                              const updatedArtists = editData.artists.filter(
            ...
            <ModalBody>
              ...
              <FormControl isRequired mt={4}>
                ...
                <Input
                  type="time"
                  value={newData?.time || ""}
                  onChange={(e) => handleNewInputChange(e, "time")}
