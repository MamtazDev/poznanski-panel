...
export interface TipTapProps {
  ...
  setArticle?: any; //React.Dispatch<React.SetStateAction<string>>;
...
const TipTap: React.FC<TipTapProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("click", (event) => handlePlayButton(event));
    };
  }, []);
        ...
        {editable ? (
          <>
            <div
              ...
              {/* {editable && <p className="label-text">Treść Twojego newsa</p>} */}
              {editor && (
                <MenuBar
                  editor={editor}
          ...
          <div
            className={!themeMode ? "text-stone-400" : "text-stone-500"}
