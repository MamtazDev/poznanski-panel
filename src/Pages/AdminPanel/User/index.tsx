...
// const UserMainPage: React.FC<ArticleProps> = ({ tagData }) => {
//   const [cardData, setCardData] = useState<Users[]>([]);
//   const [modalData, setModalData] = useState<Users>({
//     id: "",
//     nickname: "",
//     email: "",
//     role: "",
...
//     apiPutReq("/user", {...modalData, ...modalData.content[0]}).then((res) => {
//       console.log(res);
...
//   const handleAddData = () => {
//     apiPostReq("/user", modalData).then((res) => {
//       console.log(res);
...
//     apiDeleteReq("/user", { id: modalData.id }).then((res) => {
//       if (res.success) {
//         if (res.deleted) {
//           setCardData((prevState) =>
