...
const ConcertContent: React.FC<TableProps> = (props) => {
    ...
    if (id) {
      ...
      if (videoInfo) {
        setData((prev: any) => ({
          ...prev,
          link: url,
          img: videoInfo.thumbnail || prev.img,
          name: videoInfo.title || prev.name,
          description: videoInfo.description || prev.description,
        }));
      } else {
        setData((prev: any) => ({ ...prev, link: url }));
      }
    } else {
      setData((prev: any) => ({ ...prev, link: url }));
    }
  ...
  const handleYoutubeUrl = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setNewData((prev: any) => ({ ...prev, link: url }));
  ...
  const handleEditYoutubeUrl = (e: React.ChangeEvent<HTMLInputElement>) => {
    const url = e.target.value;
    setEditData((prev: any) => ({ ...prev, link: url }));
